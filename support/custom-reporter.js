...
class CustomReporter {
  ...
  onEnd(result) {
    ...
    console.log('\n📝 Reports Generated:');
    console.log(`   📄 Detailed Report: generated/reports/custom/detailed-test-report.html`);
...
<body>
    ...
    <div class="test-section">
        ...
        <ul>
            <li><code>generated/features/</code> - Cucumber feature files</li>
            <li><code>generated/steps/</code> - Step definition files</li>
            <li><code>generated/pages/</code> - Page object files (update locators here)</li>
            <li><code>generated/tests/</code> - Playwright test files</li>
            <li><code>generated/summary/</code> - Guide files with detailed instructions</li>
        </ul>
    </div>
</body>
</html>`;

    const reportPath = 'generated/reports/custom/detailed-test-report.html';
    ...
    fs.writeFileSync('generated/reports/custom/detailed-results.json', JSON.stringify(detailedJsonReport, null, 2));
  }
}
