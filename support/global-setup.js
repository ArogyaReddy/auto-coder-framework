  ...
  try {
    ...
    if (authConfig.enabled) {
      ...
      try {
        ...
        const authFile = path.join(__dirname, '..', 'generated/auth-state.json');
        ...
        const screenshotPath = path.join(__dirname, '..', 'generated/reports/screenshots/adp-login-page.png');
    ...
    const logPath = path.join(__dirname, '../generated/reports/test-execution.log');
