...
program
    .command('generate')
    .description('Generate test artifacts from a requirement')
    .argument('<requirement>', 'The requirement text to generate from')
    .option('-o, --output <path>', 'Output directory', './generated')
    .option('-f, --framework <framework>', 'Testing framework (playwright, jest, multi)', 'playwright')
...
program
    ...
    .action(() => {
        ...
        console.log('   auto-coder i --output ./generated\n');
